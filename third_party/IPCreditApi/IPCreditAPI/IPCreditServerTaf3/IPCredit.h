...
namespace newIPPro
{
    ...
    public:
        ...
        {
            resetDefautlt();
            taf::Int32 eTemp0 = newIPPro::ECountry;
            _is.read(eTemp0, 0, true);
            type = (newIPPro::ReportType)eTemp0;
    ...
    public:
        ...
        void checkChange(const std::string & contentMd5,newIPPro::CheckInfo &info,const map<string, string> &context = TAF_CONTEXT(),map<string, string> * pResponseContext = NULL);
        ...
        void checkChangeAdv(const newIPPro::CheckReq & req,newIPPro::CheckInfo &info,const map<string, string> &context = TAF_CONTEXT(),map<string, string> * pResponseContext = NULL);
        ...
        void totalDownloadIPInfo(taf::UInt32 StartPos,taf::UInt32 StartPos1,taf::UInt32 chunkLen,newIPPro::downloadInfo &loadInfo,const map<string, string> &context = TAF_CONTEXT(),map<string, string> * pResponseContext = NULL);
        ...
        void totalDownloadCode(vector<newIPPro::CodeInfo> &vCodeInfo,const map<string, string> &context = TAF_CONTEXT(),map<string, string> * pResponseContext = NULL);
        void async_totalDownloadCode(IPCreditPrxCallbackPtr callback,const map<string, string> &context = TAF_CONTEXT());

        taf::Int32 getConf(newIPPro::ClientConf &conf,const map<string, string> &context = TAF_CONTEXT(),map<string, string> * pResponseContext = NULL);
        void async_getConf(IPCreditPrxCallbackPtr callback,const map<string, string> &context = TAF_CONTEXT());

        taf::Int32 reportLogs(const vector<std::string> & logContents,const map<string, string> &context = TAF_CONTEXT(),map<string, string> * pResponseContext = NULL);
        ...
        taf::Int32 report(const map<newIPPro::ReportInfo, taf::Int64> & values,const map<string, string> &context = TAF_CONTEXT(),map<string, string> * pResponseContext = NULL);
        ...
        IPCreditProxy* taf_set_timeout(int msecond);
        IPCreditProxy* taf_loaded();
    };
