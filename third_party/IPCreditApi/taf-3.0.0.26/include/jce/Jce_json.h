...
public:
    ...
    {
        if(NULL != p && p->getType() == eJsonTypeBoolean)
        {
    ...
    {
        if(NULL != p && p->getType() == eJsonTypeNum)
        {
    ...
    {
        if(NULL != p && p->getType() == eJsonTypeString)
        {
    ...
    {
        if(NULL != p && p->getType() == eJsonTypeObj)
        {
    ...
    {
        if(NULL != p && p->getType() == eJsonTypeArray)
        {
