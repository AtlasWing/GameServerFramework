 ...
 */
  ...
  #include "zconf.h"
    ...
    typedef void *(*alloc_func)(void *opaque, DWORD items, DWORD size);
    ...
    typedef struct z_stream_s
    {
      ...
      BYTE *msg; /* last error message, NULL if no error */
    ...
    #define zlib_version zlibZIPVersion()
    ...
    ZEXTERN int ZEXPORT deflateSetDictionary(z_streamp strm, const Bytef *dictionary, DWORD dictLength);
    /*
    ...
    ZEXTERN DWORD ZEXPORT deflateBound(z_streamp strm, DWORD sourceLen);
    /*
    ...
    ZEXTERN int ZEXPORT inflateSetDictionary(z_streamp strm, const Bytef *dictionary, DWORD dictLength);
    /*
    ...
    typedef DWORD(*in_func)(void *, BYTE **);
    typedef int(*out_func)(void *, BYTE *, DWORD);

    ZEXTERN int ZEXPORT inflateBack(z_stream FAR *strm, in_func in, void *in_desc, out_func out, void *out_desc);
    ...
    ZEXTERN DWORD ZEXPORT zlibCompileFlags(void);
    ...
    //ZEXTERN int ZEXPORT compress OF((Bytef *dest,   DWORDf *destLen,
    //                                 const Bytef *source, unsigned sourceLen));
